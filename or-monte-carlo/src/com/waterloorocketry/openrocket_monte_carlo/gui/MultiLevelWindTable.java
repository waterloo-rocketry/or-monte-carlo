...
public class MultiLevelWindTable extends info.openrocket.swing.gui.simulation.MultiLevelWindTable {
    ...
    private static final ColumnDefinition[] COLUMNS = {
            ...
            new ColumnDefinition("Wind Direction Std Dev", 100, UnitGroup.UNITS_ANGLE),
    ...
    private static void initColors() {
        updateColors();
        UITheme.Theme.addUIThemeChangeListener(info.openrocket.swing.gui.simulation.MultiLevelWindTable::updateColors);
    }
    ...
    private UnitSelector createUnitSelector(int columnIndex, UnitGroup unitGroup) {
        ...
        switch (columnIndex) {
            ...
            case 3: // Direction
                ...
                break;
            case 4: // Direction Std Dev
                selector = new UnitSelector(unitDirectionStdDevModel);
                //selector.addItemListener(e -> updateDirectionStdDevUnits(selector.getSelectedUnit()));
                break;
            case 5: // Turbulence
    ...
    public void addRow() {
        ...
        //double newDirectionStdDev = prevRow != null ? prevRow.getLevel().getDirectionStdDev() : 0;

        // Add to model TODO: How to handle direction std dev?
    ...
    private record ColumnDefinition(String header, String headerTooltip, int width, UnitGroup unitGroup) {
